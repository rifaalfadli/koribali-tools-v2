...
export default function Beranda() {
  ...
  useEffect(() => {
    // Cek apakah login baru saja terjadi
  ...
  return (
    <>
      {showTransition && createPortal(<PageTransition />, document.body)}
      ...
      <main>
        ...
        <section id="galeri-preview" className="main-galeri">
          <div className="container">
            ...
            <div className="main-galeri-container">
              {[14, 15, 16, 17, 18, 19].map((num) => (
                <figure key={num}>
                  <img
